...
public class _06_Post_thread_reply_option_Profiles_you_mention {
...
//Adding chars to the thread and choosing reply options to profiles you mentioned
		String content_chars = "Testing for Mentioned only";

		home.newThread();
		home.threadCont(content_chars);

//Choosing 'Profiles you mention' can reply option
		home.threadReplyMentionedOnly();
		home.post();
		// Thread.sleep(5000);
		home.logout();

//Random non-mentioned user attempting to reply on thread of first user
		login.user2();
